...
import numpy as np
import os
os.environ["CUDA_VISIBLE_DEVICES"]="12" # Change the number 0 to your corresponding GPU ID in the Google Sheet
...
class VGG_Pre:
    ...
    def output_grad(self, inputs):
        ...
        # Return grad: gradients from every input node to the output of self.model(X) (numpy.array)
